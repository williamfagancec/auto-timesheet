      ...
      <div className="max-w-md w-full bg-white rounded-xl border border-border-light shadow-xl overflow-hidden animate-scale-in relative z-10">
        ...
        <div className="relative my-xl">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-md bg-white text-text-tertiary font-medium">Or continue with</span>
          </div>
        </div>
        ...
        <button
          ...
          className="btn-secondary w-full justify-center gap-md shadow-sm hover:shadow-md"
        >
